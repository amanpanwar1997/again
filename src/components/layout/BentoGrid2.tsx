      ...
      >
        ...
        ">
          ...
          <div className="
            ...
            bg-gradient-to-br from-yellow-500/0 via-yellow-500/0 to-transparent
            group-hover:from-yellow-500/10 group-hover:via-yellow-500/5
            ...
            <div className="mt-auto pt-3 flex items-center justify-between gap-2">
              ...
              {stat ? (
                <div className="
                  ...
                  bg-white/5 border border-white/10 group-hover:border-yellow-500/20
