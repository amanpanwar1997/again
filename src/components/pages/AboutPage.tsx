...
export function AboutPage() {
  const seoData = getPageKeywords('about');
  ...
  return (
    <div className="bg-black">
      ...
      <StructuredData 
        schema={[
          organizationSchema,
          getWebPageSchema(seoData.title, seoData.description, '/about', breadcrumbs),
          getBreadcrumbSchema(breadcrumbs),
        ]} 
      />
      
      {/* Hero Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 min-h-[80vh] flex flex-col justify-center">
        <div className="max-w-5xl mx-auto text-center">
          {/* P: Guidelines-compliant lead text */}
          <p className="text-[0.9375rem] leading-relaxed mb-6 text-gray-300" style={{ lineHeight: 1.6 }}>Hello</p>
          ...
          <p className="text-[0.9375rem] leading-relaxed text-gray-300 mb-4 max-w-3xl mx-auto" style={{ lineHeight: 1.6 }}>
