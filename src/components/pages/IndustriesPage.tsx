...
export function IndustriesPage() {
  const seoData = getPageKeywords('industries', 'main');
  const breadcrumbs = [
    { name: 'Home', path: '/' },
  ...
  return (
    <div className="bg-black">
      <SEOHead
        ...
        keywords={getAllKeywords('industries')}
        ogType="website"
      />
      ...
      <StructuredData 
        schema={[
          organizationSchema,
          getWebPageSchema(seoData.title, seoData.description, '/industries', breadcrumbs),
